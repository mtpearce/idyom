...
;;;; Time-stamp: <2022-10-10 11:02:38 marcusp>                           
;;;; ======================================================================
;;;;
;;;; DESCRIPTION 
;;;;
...
(defclass ppm ()
  ((leaves    :accessor ppm-leaves   :initarg :leaves   :type hash-table :initform nil)
   (branches  :accessor ppm-branches :initarg :branches :type hash-table :initform nil)
   (front     :accessor ppm-front                       :type index)
   (dataset   :accessor ppm-dataset  :initarg :dataset  :type hash-table :initform nil)
   ...
   (alphabet :accessor ppm-alphabet :initarg :alphabet :type list :initform nil)
