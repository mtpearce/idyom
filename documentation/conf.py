...
# -*- coding: utf-8 -*-
#
# IDyOM documentation build configuration file, created by
...
project = 'IDyOM'
copyright = '2017, Marcus Pearce, Peter Harrison, and Bastiaan van der Weij'
author = 'Marcus Pearce, Peter Harrison, and Bastiaan van der Weij'
...
latex_documents = [
    (master_doc, 'IDyOM.tex', 'IDyOM Documentation',
     'Marcus Pearce, Peter Harrison, and Bastiaan van der Weij', 'manual'),
]
