...
(defgeneric preview (object &key temp-dir play-audio display-score)
  (:documentation "Previews <object> using <temp-dir> as the temporary directory. If <play-audio>, an audio preview is played. If <display-score>, a pdf score is opened. Returns t if the user requests to break out of a loop, nil otherwise."))
